...
export default {
  ...
  TelegramFeatures: 'SpaceChat Features',
  ...
  Username: 'Username',
  UsernameHelp: 'You can choose a username on **SpaceChat**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  ...
  PhoneOther: 'Other',
  ContactJoined: 'Contact joined SpaceChat',
  ...
  lng_settings_sensitive_about: 'Display sensitive media in public channels on all your SpaceChat devices.',
  ...
  EnabledPasswordText: 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your SpaceChat account.',
  ...
  'Channel.Username.CreatePublicLinkHelp': 'People can share this link with others and find your channel using SpaceChat search.',
  ...
  'Group.Username.CreatePublicLinkHelp': 'People can share this link with others and find your group using SpaceChat search.',
  ...
  lng_update_telegram: 'Update SpaceChat',
  ...
  'Video.Unsupported.Desktop': 'Unfortunately, this video can\'t be played on SpaceChat Web. Try opening it with our **desktop app** instead.',
  'Video.Unsupported.Mobile': 'Unfortunately, this video can\'t be played on SpaceChat Web. Try opening it with our **mobile app** instead.',
